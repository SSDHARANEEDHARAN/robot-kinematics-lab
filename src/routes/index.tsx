...
function KinematicsLab() {
  ...
  return (
    <main className="min-h-screen px-4 pb-8 pt-0 md:px-8 max-w-[1920px] mx-auto select-none flex flex-col">
      ...
      <div className="grid gap-5 xl:grid-cols-[300px_minmax(0,1fr)_340px] xl:h-[750px]">
        {/* ---------- Left: popups ---------- */}
        ...
        {/* ---------- Center: viewport ---------- */}
        <section className="lab-card flex h-full flex-col overflow-hidden border-t-4 border-t-yellow-400 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)]">
